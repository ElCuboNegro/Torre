...
Welcome to ``Torrex`` contributor's guide.
...
If you experience bugs or general issues with ``Torrex``, please have a look
...
You can help improve ``Torrex`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Torrex`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Torrex``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Torrex.git
    cd Torrex
...
#. Install |pre-commit|_::
   ...
   ``Torrex`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Torrex
.. _issue tracker: https://github.com/<USERNAME>/Torrex/issues
.. <-- end -->
